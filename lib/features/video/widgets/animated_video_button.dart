...
class AnimatedVideoButton extends StatelessWidget {
  ...
  }) : _animationController = animationController, _isPaused = isPaused, _animationDuration = animationDuration;
        ...
        child: IgnorePointer(
          child: Center(
            child: AnimatedBuilder(
              ...
              builder: (context, child) { // child == child: AnimatedOpacity
              ...
              child: AnimatedOpacity(
                ...
                child: const FaIcon(FontAwesomeIcons.play, color: Colors.white, size: Sizes.size52),
              ),
            )
          ),
        )
