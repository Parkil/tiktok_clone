...
class AuthButton extends StatelessWidget {
  ...
  const AuthButton({super.key, required this.text, required this.icon, this.onTap});
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              Text(text, textAlign: TextAlign.center, style: const TextStyle(fontSize: Sizes.size16, fontWeight: FontWeight.w600)),
            ]
          ),
        ),
      ),
